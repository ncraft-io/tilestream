...
import (
	...
	tilestream "github.com/ncraft-io/tilestream/service-go/internal/tilestream-server"
)
...
func Run(cfg nserver.Config) {
	...
	tilestream.RegisterService(cfg, r, s)
	...
	// Run!
	logs.Info("tilestream.Unified.Server", " started.")
	logs.Info("tilestream.Unified.Server", <-errc)
	logs.Info("tilestream.Unified.Server", " closed.")
}
